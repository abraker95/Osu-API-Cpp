...
#include "../../header/JsonCpp/json/assertions.h"
#include "../../header/JsonCpp/json/value.h"
#include "../../header/JsonCpp/json/writer.h"
...
#include "../../header/JsonCpp/json_valueiterator.inl"
#endif // if !defined(JSON_IS_AMALGAMATION)
...
/*std::string Value::getData(int _index, bool _type)
{
	if (_type)
		return value_.map_->at(_index).asString();
	else
		return resolveReference(value_.map_->at(_index).asCString(), "").asString();
}*/
